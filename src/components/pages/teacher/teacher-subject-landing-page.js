...
import classes from "./teacher-subject-landing-page.module.css";
import { fetchToken } from "../../../Auth";
import axios from "axios";
import QuizCard from "../../ui-elements/card/quizCard";
import JoinQuizModal from "../../modal-dialog/join-quiz-modal";
import TeacherQuizCard from "../../ui-elements/card/teacherQuizCard";

function TeacherSubjectPage(props) {
  ...
  useEffect(() => {
        ...
        const fetchData = async () => {
          ...
          const API_URL = "http://localhost:8000/quiz/course-quizzes/" + courses._id;
            try {
